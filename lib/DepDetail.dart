...
class DepDetail extends StatelessWidget {
  const DepDetail({ Key? key , required this.id,required this.uid}) : super(key: key);
  final  id;
  final uid;
  @override
         ...
         children:[
          Column(
            children: [
              ...
              StreamBuilder(
                stream: FirebaseFirestore.instance.collection('Schemes').orderBy('Likes').where('Department',isEqualTo: id).snapshots(),
